...
public class Savings_productVO {
    ...
    private String j_interest_rate;
    private String j_type;
    private String j_max_date;
    private String j_min_date;
    private String j_explanation;
    private String j_notice;
    private String j_auto_date;
    ...
    public String getJ_interest_rate() {
        return j_interest_rate;
    }

    public void setJ_interest_rate(String j_interest_rate) {
    ...
    public String getJ_max_date() {
        return j_max_date;
    }

    public void setJ_max_date(String j_max_date) {
        this.j_max_date = j_max_date;
    }

    public String getJ_min_date() {
        return j_min_date;
    }

    public void setJ_min_date(String j_min_date) {
    ...
    public String getJ_auto_date() {
        return j_auto_date;
    }

    public void setJ_auto_date(String j_auto_date) {
