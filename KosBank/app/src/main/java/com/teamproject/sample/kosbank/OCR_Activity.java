...
public class OCR_Activity extends AppCompatActivity {
    ...
    private static final String TAG = OCR_Activity.class.getSimpleName();
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, Map<String,String>> {
        private final WeakReference<OCR_Activity> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(OCR_Activity activity, Vision.Images.Annotate annotate) {
