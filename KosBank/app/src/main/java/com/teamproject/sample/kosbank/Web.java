...
public class Web {
    ...
    //    <beans:property name="jndiName" value="java:comp/env/jdbc/Oracle11g_65" 로 수정
    //    context.xml  id: android_65   /   password : tiger


    // 3. 크롬 실행 : http://localhost:8081/gsonEx/
    // ipconfig 확인 .. 연결이 끊김 으로 되어있으면 연결불가
    public static String ip = "192.168.219.106"; //본인 IP
